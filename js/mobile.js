function mobile() {
    if (
        ...
        var elem = document.getElementsByClassName("navlink");
        var hr1 = elem[0].getAttribute("href");
        var hr2 = elem[1].getAttribute("href");
        var text1 = elem[0].innerHTML;
        var text2 = elem[1].innerHTML;
        for (var i = 0; i < elem.length; i + 1) {
            elem[i].remove();
        }

        var hhi = document.createElement("div");
        hhi.setAttribute("class", "hhi");

        var con = document.createElement("div");
        con.setAttribute("class", "container div");
        con.style.bottom = "0";
        con.style.position = "fixed";
        con.style.margin = "0 0";
        con.style.padding = "0 0";
